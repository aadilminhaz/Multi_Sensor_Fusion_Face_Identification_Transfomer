...
def update_graph(epoch, train_losses, test_accuracies):
    ...
    print('Val Loss till now : ', test_accuracies)
    plt.figure(figsize=(10, 5))
    
    plt.plot(train_losses, label='Train Loss')
    plt.plot(test_accuracies, label='Val Loss')
    ...
    for epoch in trange(N_EPOCHS, desc="Training"):
        ...
        with torch.no_grad():
            ...
            if val_loss < best_eval_score:
                ...
                model_name = 'Fusion_Transfomer_ADAMW_{}_best.pth'.format(kFold)

                stable_best_score_epoch = 0

                #save the model
                print('saving model with validation loss : ',best_eval_score)
        ...
        model_name_epoch = 'Fusion_Transfomer_ADAMW_{}_epoch.pth'.format(kFold)
